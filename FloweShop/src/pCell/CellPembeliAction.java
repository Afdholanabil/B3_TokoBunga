...
public class CellPembeliAction extends TableCustomCell {

    public CellPembeliAction() {
        initComponents();
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (checkDataStatic == true) {
                        ...
                        String idpembeli = ((ModelBodyPembeli) data).getIdp().getIdPembeli();
                        new ServicePembeli().deletePembeli(idpembeli, mrp);
                        if (mrp.getKode() == 1) {
    ...
    public Component createComponentCellRender(TableCustom table, TableRowData data, int row, int column) {
        CellPembeliAction cell = new CellPembeliAction();
        cell.checkIcon(data);
